...
$taskName = 'Clear English BBC Course Agent'
...
Register-ScheduledTask -TaskName $taskName -Action $action -Trigger $trigger -Settings $settings -Description 'Local-only Clear English BBC course agent' -Force | Out-Null
